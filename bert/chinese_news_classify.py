...
# 模型和分词器本地路径配置
LOCAL_MODEL_PATH = "../pretrained_models/bert-base-chinese"  # 本地模型路径
TOKENIZER_PATH = "../pretrained_models/bert-base-chinese"  # 本地分词器路径
...
# 加载数据集
train_dataset, valid_dataset = load_excel_data("../chinese_news.xlsx")
...
def compute_metrics(p):
    ...
    # 日志写入
    with open("chinese_metrics_log.txt", "a") as f:
...
# 8. 保存微调后的模型
model.save_pretrained("./chinese_news_classifier")
tokenizer.save_pretrained("./chinese_news_classifier")
